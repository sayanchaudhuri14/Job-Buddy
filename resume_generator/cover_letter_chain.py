...
def generate_cover_letter(job_description, candidate_info):
    ...
    cover_letter = cover_letter_chain.run(job_description=job_description, candidate_info=candidate_info)
    return cover_letter
